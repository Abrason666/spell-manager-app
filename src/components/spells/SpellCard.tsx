...
export function SpellCard({ spell, isInList, onAdd, onRemove, onViewDetail }: SpellCardProps) {
  ...
  return (
    ...
    >
      {/* Livello */}
      <div className="flex h-8 w-8 shrink-0 items-center justify-center rounded-full bg-primary/15 text-primary ring-1 ring-primary/30 text-xs font-bold font-fantasy">
